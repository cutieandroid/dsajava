...
/**
 * DLinkedlistinsertend
 */
public class DLinkedlistinsertend {
    ...
    private void insert_end(int value) {
        ...
        // make the prev gend as the prev of newnode
        newnode.prev = gend;
        // make the newnode as the new gend
        gend = newnode;
        // increment length
        length++;
    ...
    public static void main(String[] args) {
        DLinkedlistinsertend dl = new DLinkedlistinsertend();
