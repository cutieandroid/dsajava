...
public class Linkedlistinsertatend {
    ...
    private void insertend(int data) {
        ...
        gend.next = newnode; // pointing the next of the current last node to the new node
        gend = newnode; // assigning the new node as the last node
    }
    ...
    public static void main(String[] args) {
        ...
        ll.printList();
        ll.insertend(100);
        System.out.println("list after inserting a node at the end:");
        ll.printList();
